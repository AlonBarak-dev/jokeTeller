...
__all__ = [ 'FontEvents', 'OLE_YPOS_HIMETRIC', 'FONTITALIC',
           'FONTUNDERSCORE', 'VgaColor', 'OLE_CANCELBOOL',
           'OLE_XPOS_CONTAINER', 'LoadPictureConstants', 'Font',
           'Unchecked', 'IPictureDisp', 'Default', 'StdFont', 'IFont',
           'OLE_YPOS_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSTRIKETHROUGH', 'StdPicture', 'Monochrome',
           'OLE_COLOR', 'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS',
           'FONTBOLD', 'OLE_XPOS_HIMETRIC', 'Picture', 'Gray',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_PIXELS', 'FONTSIZE', 'IFontDisp', 'Checked',
           'OLE_XPOS_PIXELS', 'OLE_OPTEXCLUSIVE', 'FONTNAME',
           'OLE_TRISTATE', 'OLE_YSIZE_CONTAINER', 'OLE_HANDLE',
           'OLE_XSIZE_CONTAINER', 'IPicture', 'Color',
           'IFontEventsDisp']
from comtypes import _check_version; _check_version('1.1.10', 1575709751.817330)
